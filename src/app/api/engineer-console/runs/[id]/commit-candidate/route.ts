...
export async function GET(
  ...
  const candidates = listCommitCandidatesForRun(runId).map((row) => ({
    ...
    completionReadinessStatus: row.completionReadinessStatus,
    completionReadinessDecision: row.completionReadinessDecision,
    completionReadinessReviewedAt: row.completionReadinessReviewedAt,
