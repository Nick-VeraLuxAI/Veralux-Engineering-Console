  ...
  return (
    <section className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-4">
      <div className="mb-1 flex flex-wrap items-center gap-2">
        <h2 className="font-semibold">Release sign-off</h2>
        <OperatorHelp term="release_signoff" label="What is release sign-off?" />
      </div>
      <p className="mb-4 text-sm text-[var(--muted)]">
        Admin-only go / no-go record. Sign-off captures the release decision only. It does not
        deploy, rollback, or trigger CI/CD.
      </p>
        ...
        <>
          <div className="mb-4 rounded border border-[var(--border)] p-3 text-sm">
            ...
            {!checklist?.evaluatedAt && checklistStatus === "unknown" && (
              <p className="text-amber-300">
                Check the release checklist before signing off. A saved checklist evaluation is required
                first.
              </p>
            )}
          </div>
          ...
          <div className="mb-4 space-y-3 text-sm">
            <label className="flex items-center gap-2">
              ...
              />
              Completed (all checklist items must be complete)
            </label>
            <label className="flex items-center gap-2">
              <input
                type="radio"
              ...
              />
              Completed with exceptions (allowed only when the checklist needs attention, with rationale)
            </label>
            <label className="flex items-center gap-2">
              <input
                type="radio"
              ...
              />
              Rejected (use when release should not proceed; rationale required)
            </label>
            <textarea
