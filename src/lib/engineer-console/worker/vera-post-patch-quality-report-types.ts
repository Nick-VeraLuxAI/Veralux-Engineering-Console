...
export const VERA_IMPLEMENTATION_POST_PATCH_QUALITY_REPORT_APPROVED_STEP =
  "implementation_post_patch_quality_report_approved";

export const VERA_IMPLEMENTATION_POST_PATCH_QUALITY_REPORT_REJECTED_STEP =
  "implementation_post_patch_quality_report_rejected";

export const VERA_POST_PATCH_QUALITY_REPORT_APPROVE_CONFIRMATION =
  "APPROVE VERA POST-PATCH QUALITY REPORT";

export const VERA_POST_PATCH_QUALITY_REPORT_REJECT_CONFIRMATION =
  "REJECT VERA POST-PATCH QUALITY REPORT";
