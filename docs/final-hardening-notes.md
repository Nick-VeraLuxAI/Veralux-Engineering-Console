...
| [intelligence-layer-audit.md](./intelligence-layer-audit.md) | A1 audit of danger-point interpretation, risk classification readiness, escalation design, and autonomy guardrails |
| [intelligence-layer-guide.md](./intelligence-layer-guide.md) | Operator guide to the read-only A1 run intelligence card, risk labels, confidence, escalation, and future playbooks |
